    ...
    render() {
        return (
            ...
            <nav className="navbar navbar-light bg-white p-0 pb-1 inline sticky-top" style={{ height: '55px' }}>
                ...
                <a className="navbar-brand inline" href="#">
                    ...
                    <h5 className="navbar-brand text-dark mx-2" href='#'>Reddit</h5>
                </a>
                <form className="form-inline text-center">
                    <input className="form-control mr-sm-2" style={{ height: '40px', width: '63vw' }} type="search" placeholder="Search" aria-label="Search" />
                    {/* <button className="btn btn-outline-primary my-2 my-sm-0" type="submit">Search</button> */}
                </form>
                <div className='navbar-right'>
                    <button className='mx-2 btn btn-outline-primary' href="#">Login</button>
                    <button className='mx-2 btn btn-primary' href="#">Sign Up</button>
                </div>
            </nav>
            // </div>
        )
